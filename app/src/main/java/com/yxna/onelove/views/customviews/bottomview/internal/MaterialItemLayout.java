package com.yxna.onelove.views.customviews.bottomview.internal;
...
import com.yxna.onelove.views.customviews.bottomview.ItemController;
import com.yxna.onelove.views.customviews.bottomview.MaterialMode;
...
import com.yxna.onelove.views.customviews.bottomview.listener.SimpleTabItemSelectedListener;
...
public class MaterialItemLayout extends ViewGroup implements ItemController {
    ...
    public void initialize(List<MaterialItemView> items, List<Integer> checkedColors, int mode,
                           boolean animateLayoutChanges, boolean doTintIcon, int color, int ripperColor) {
        ...
        if ((mode & MaterialMode.CHANGE_BACKGROUND_COLOR) > 0) {
            ...
            for (int i = 0; i < mItems.size(); i++) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    int rColor;
                    if (ripperColor == 0) {
                        rColor = checkedColors.get(i);
                    } else {
                        rColor = ripperColor;
                    }
                    v.setBackground(new RippleDrawable(new ColorStateList(new int[][]{{}}, new int[]{0xFFFFFF & rColor | 0x56000000}), null, null));
                } else {
