package com.yxna.onelove.views.customviews.bottomview;
...
import com.yxna.onelove.views.customviews.bottomview.internal.CustomItemLayout;
import com.yxna.onelove.views.customviews.bottomview.internal.CustomItemVerticalLayout;
import com.yxna.onelove.views.customviews.bottomview.internal.MaterialItemLayout;
import com.yxna.onelove.views.customviews.bottomview.internal.MaterialItemVerticalLayout;
import com.yxna.onelove.views.customviews.bottomview.internal.Utils;
import com.yxna.onelove.views.customviews.bottomview.item.BaseTabItem;
import com.yxna.onelove.views.customviews.bottomview.item.MaterialItemView;
import com.yxna.onelove.views.customviews.bottomview.item.OnlyIconMaterialItemView;
import com.yxna.onelove.views.customviews.bottomview.listener.OnTabItemSelectedListener;
...
public class PageNavigationView extends ViewGroup {
    ...
    public class MaterialBuilder {
        ...
        /**
         *  设置5.0以上系统，按钮水波纹颜色
         * @param color 按钮水波纹效果颜色
         */
        public MaterialBuilder setRipperColor(@ColorInt int color) {
            ripperColor = color;
            return this;
        }
        ...
        public NavigationController build() {
            ...
            if (enableVerticalLayout) {//垂直布局
                ...
                materialItemLayout.initialize(items, checkedColors, mode, animateLayoutChanges, doTintIcon,
                        defaultColor, ripperColor);
